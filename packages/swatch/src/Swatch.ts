 ...
 * @element sp-swatch
 */
export class Swatch extends SizedMixin(SpectrumElement, {
    validSizes: ['xs', 's', 'm', 'l'],
}) {
    ...
    public border: 'light' | 'none' | undefined;
    ...
    @property({ reflect: true })
    public rounding: 'none' | 'full' | undefined;

    @property({ type: Boolean, reflect: true })
    public selected = false;

    @property({ reflect: true })
    public shape: 'rectangle' | undefined;
