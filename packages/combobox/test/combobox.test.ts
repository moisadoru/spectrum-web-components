...
describe('Combobox', () => {
    ...
    describe('renders accessibly', () => {
        ...
        it('renders open', async () => {
            /**
             * axe-core is testing for the 1.1 version of the aria role="combobox" pattern:
             * https://www.w3.org/TR/wai-aria-1.1/#combobox
             * We are implementing the 1.2 version fo the aria role="combobox" pattern"
             * https://w3c.github.io/aria-practices/#combobox
             *
             * We should stop skipping this test when axe-core has caught up to the latest
        ...
        xit('manages aria-selected', async () => {
            const el = await comboboxFixture();
